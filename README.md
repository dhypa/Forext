...
quickly set up react project to display ccy pairings

*maybe* set up dashboard to manage ccy pairings

figure out auth stuff for user

make simple kyc mock

make simple pricer service mock

implement live feed on frontend to read from pricer

implement basic executor

CI/CD time 
- figure out what a k8s is meant to be
- make pipelines 

Mock book keeper and integrate with executor
